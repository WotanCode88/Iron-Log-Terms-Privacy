...
We grant you a limited, non-exclusive, non-transferable license to use Iron Log on devices that you own or control, subject to these Terms.

⸻

2. Subscriptions and purchases

Iron Log includes in-app purchases and auto-renewable subscriptions.
    •    Purchases are handled by Apple via the App Store.
...
For billing or refund questions, please contact Apple Support.

⸻

3. Local data storage

All user data in Iron Log (workouts, measurements, logs) is stored exclusively on your device.
    •    We do not collect, transmit, or store any user data on external servers.
    •    You are responsible for managing your own backups (e.g., iCloud or device backups).

Deleting the App permanently deletes all stored data from your device.
...
The App does not send any user data to remote servers.

If future versions introduce network-based features, they will require your explicit consent.
...
You agree not to:
    ...
    •    Bypass any technical or security protections
...
To the maximum extent permitted by applicable law, we disclaim all warranties, including implied warranties of merchantability and fitness for a particular purpose.
